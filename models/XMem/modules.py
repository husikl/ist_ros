...
class ValueEncoder(nn.Module):
    ...
    def forward(self, image, image_feat_f16, h, masks, others, is_deep_update=True):
        ...
        if not self.single_object:
            ...
            g = masks.unsqueeze(2)
        g = self.distributor(image, g) # ! (b, 3, h, w), (b, n_obj, 2, h, w) -> (b, n_obj, 5, h, w)
        ...
        g = g.view(batch_size, num_objects, *g.shape[1:]) # ! (b, n_obj, c, h', w')
        g = self.fuser(image_feat_f16, g) # # ! (b, c', h', w') , (b, n_obj, c, h', w')
